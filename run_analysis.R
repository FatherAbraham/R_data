...
##assumes the data has been downloaded and extracted in the current directory, so set new working directory
...
##write out the file
write.table(finished_data, file = "Tidy Data Set.txt", sep = " ", eol = "\n", col.names = TRUE, row.name=FALSE)
